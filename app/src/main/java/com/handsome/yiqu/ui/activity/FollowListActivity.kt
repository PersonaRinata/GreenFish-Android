...
import com.handsome.yiqu.databinding.MainActivityFollowListBinding
import com.handsome.yiqu.ui.adapter.FollowAdapter
import com.handsome.yiqu.ui.viewmodel.activity.FollowListViewModel
...
class FollowListActivity : BaseActivity() {
    ...
    private lateinit var mCurrentUser : AuthorBean   // 后面可以考虑替换成全局变量
    ...
    private fun initValue() {
        mCurrentUser = intent.getSerializableExtra("currentUser") as AuthorBean
    ...
    companion object{
        fun startAction(context : Context,currentUser : AuthorBean,followType: FollowType){
