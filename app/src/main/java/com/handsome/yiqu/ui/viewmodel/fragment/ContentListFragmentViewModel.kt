...
import com.handsome.yiqu.ui.fragment.FindFragment.Companion.TYPE_ALL
import com.handsome.yiqu.ui.fragment.FindFragment.Companion.TYPE_FOOD
import com.handsome.yiqu.ui.fragment.FindFragment.Companion.TYPE_LIFE
import com.handsome.yiqu.ui.fragment.FindFragment.Companion.TYPE_MEDICINE
        ...
        viewModelScope.launch(myCoroutineExceptionHandler){
            ...
            when(type){
                ...
                ContentType.MEDICINE -> {
                    ...
                    _mutableContentList.emit(ContentList(status_code = 0, status_msg = "",contentList))
                }
                ContentType.FOOD -> {
