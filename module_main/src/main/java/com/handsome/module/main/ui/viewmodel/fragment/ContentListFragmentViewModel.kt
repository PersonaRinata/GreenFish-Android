...
import com.handsome.module.main.bean.ContentType
import com.handsome.module.main.ui.fragment.FindFragment.Companion.TYPE_ALL
import com.handsome.module.main.ui.fragment.FindFragment.Companion.TYPE_FOOD
import com.handsome.module.main.ui.fragment.FindFragment.Companion.TYPE_LIFE
import com.handsome.module.main.ui.fragment.FindFragment.Companion.TYPE_MEDICINE
        ...
        viewModelScope.launch(myCoroutineExceptionHandler){
            ...
            when(type){
                ...
                ContentType.MEDICINE -> {
                    val contentList = fakeData.contentList.filter { it.types.contains(TYPE_MEDICINE) }
                    _mutableContentList.emit(
                        ContentList(
                            status_code = 0,
                            status_msg = "",
                            contentList
                ...
                ContentType.FOOD -> {
                    val contentList = fakeData.contentList.filter { it.types.contains(TYPE_FOOD) }
                    _mutableContentList.emit(
                        ContentList(
                            status_code = 0,
                            status_msg = "",
                ...
                ContentType.LIFE -> {
                    val contentList = fakeData.contentList.filter { it.types.contains(TYPE_LIFE) }
                    _mutableContentList.emit(
                        ContentList(
                            status_code = 0,
                            status_msg = "",
